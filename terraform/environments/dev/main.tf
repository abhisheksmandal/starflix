...
module "alb" {
  ...
  acm_certificate_arn         = var.enable_https ? var.frontend_acm_certificate_arn : null
  backend_acm_certificate_arn = var.enable_https ? var.backend_acm_certificate_arn : null
